...
function responsi_a3_shortcode_addon_activate_validate(){
    ...
    update_option('a3rev_responsi_a3_shortcode_addon_version', '2.8.6');
...
function responsi_addon_shortcode_upgrade_version () {
	if( version_compare(get_option('a3rev_responsi_a3_shortcode_addon_version'), '2.8.6') === -1 ){
        global $responsi_a3_shortcode_addon;
        //$theme = get_option( 'stylesheet' );
        //$version = str_replace('.', '_', '2.8.6');
