<?php
class Shortcode_Columns_FiveSixth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_five-sixth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_five-sixth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'five-sixth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'five-sixth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-five-sixth responsi-layout-column responsi-column';
		$attr['style'] = '';
