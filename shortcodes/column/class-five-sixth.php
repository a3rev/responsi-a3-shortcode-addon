...
class FiveSixth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), \A3Rev\RShortcode\HookFunction::attributes( 'five-sixth-shortcode' ), \A3Rev\RShortcode\HookFunction::attributes( 'five-sixth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
