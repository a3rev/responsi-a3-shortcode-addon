<?php
class Shortcode_Columns_FourFifth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_four-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_four-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'four-fifth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'four-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-four-fifth responsi-layout-column responsi-column';
		$attr['style'] = '';
