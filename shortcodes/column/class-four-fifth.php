...
class FourFifth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), \A3Rev\RShortcode\HookFunction::attributes( 'four-fifth-shortcode' ), \A3Rev\RShortcode\HookFunction::attributes( 'four-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
