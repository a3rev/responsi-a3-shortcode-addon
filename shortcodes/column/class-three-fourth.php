<?php
class Shortcode_Columns_ThreeFourth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_three-fourth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_three-fourth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'three-fourth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'three-fourth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-three-fourth three_fourth responsi-layout-column responsi-column';
		$attr['style'] = '';
