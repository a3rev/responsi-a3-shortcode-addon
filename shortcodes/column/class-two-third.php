<?php
class Shortcode_Columns_TwoThird {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_two-third-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_two-third-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'two-third-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'two-third-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-two-third two_third responsi-layout-column responsi-column';
		$attr['style'] = '';
