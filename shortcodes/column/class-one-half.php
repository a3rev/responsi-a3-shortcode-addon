<?php
class Shortcode_Columns_OneHalf {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_one-half-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_one-half-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'one-half-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'one-half-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-one-half one_half responsi-layout-column responsi-column';
		$attr['style'] = '';
