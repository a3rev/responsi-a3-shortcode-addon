...
class OneFifth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_one-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_one-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-one-fifth responsi-layout-column responsi-column';
		$attr['style'] = '';
