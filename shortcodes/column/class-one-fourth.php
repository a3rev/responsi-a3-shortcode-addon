<?php
class Shortcode_Columns_OneFourth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_one-fourth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_one-fourth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'one-fourth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'one-fourth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-one-fourth one_fourth responsi-layout-column responsi-column';
		$attr['style'] = '';
