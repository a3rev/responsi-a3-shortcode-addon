...
class OneFourth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), \A3Rev\RShortcode\HookFunction::attributes( 'one-fourth-shortcode' ), \A3Rev\RShortcode\HookFunction::attributes( 'one-fourth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
