<?php
class Shortcode_Columns_OneThird {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_one-third-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_one-third-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'one-third-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'one-third-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-one-third one_third responsi-layout-column responsi-column';
		$attr['style'] = '';
