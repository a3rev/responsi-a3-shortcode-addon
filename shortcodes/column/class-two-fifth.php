<?php
class Shortcode_Columns_TwoFifth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_two-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_two-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'two-fifth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'two-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-two-fifth responsi-layout-column responsi-column';
		$attr['style'] = '';
