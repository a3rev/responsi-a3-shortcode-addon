...
class TwoFifth {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), \A3Rev\RShortcode\HookFunction::attributes( 'two-fifth-shortcode' ), \A3Rev\RShortcode\HookFunction::attributes( 'two-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
