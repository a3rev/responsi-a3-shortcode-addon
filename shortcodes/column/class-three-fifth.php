<?php
class Shortcode_Columns_ThreeFifth {
	...
	public function __construct() {
		...
		add_filter( 'responsi_shortcode_attr_three-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'responsi_shortcode_attr_three-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( trim('<div %s><div %s>%s</div></div>%s'), Responsi_A3_Shortcode_Class::attributes( 'three-fifth-shortcode' ), Responsi_A3_Shortcode_Class::attributes( 'three-fifth-shortcode-wrapper' ), do_shortcode( $content ), $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'responsi-three-fifth responsi-layout-column responsi-column';
		$attr['style'] = '';
