...
jQuery.fn.responsi_switch_tab_on_link_click = function() {
...
+function ($) {
  ...
  Collapse.prototype.show = function () {
	...
	var actives = this.$parent && this.$parent.find('> .responsi-panel > .in');
...
jQuery(document).ready(function($) {
	...
	//Tabs
	jQuery( '.responsi-tabs' ).responsi_switch_tab_on_link_click();
	...
	// Toggles
	jQuery('.responsi-accordian .panel-title a').click(function(e) {
		e.preventDefault();
	});
