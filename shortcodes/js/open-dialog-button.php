	  ...
	  <div class="sort_table_item" id="sort_table_item-1">
		<table class="responsi-options-table">
			...
			<tr>
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#000000" data-default-color="#000000" id="responsi-value-background" name="responsi-value-background" class="responsi-color-picker" style="display:none" />
				</td>
			</tr>
			<tr>
				<th width="23%" valign="top" scope="row">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#555555" data-default-color="#555555" id="responsi-value-gradient_from" name="responsi-value-gradient_from" class="responsi-color-picker" style="display:none" />
				</td>
			</tr>
			<tr>
				<th width="23%" valign="top" scope="row">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#000000" data-default-color="#000000" id="responsi-value-gradient_to" name="responsi-value-gradient_to" class="responsi-color-picker" style="display:none" />
				</td>
			</tr>
			<tr>
		...
		<table class="responsi-options-table container">
			...
			<tr class="divider">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#FFFFFF" data-default-color="#FFFFFF" id="responsi-value-divider_color" name="responsi-value-divider_color" class="responsi-color-picker" style="display:none" />
				</td>
			</tr>
		</table>
		<table class="responsi-options-table">
