							...
							<table class="responsi-options-table">
								...
								<tr class="icon_bg">
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_backgroundcolor']['color'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_backgroundcolor']['color'];?>" id="responsi-value-backgroundcolor" name="responsi-value-backgroundcolor" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
						...
						<td colspan="2" style="padding-right:0;">
							<table class="responsi-options-table">
								...
								<tr class="icon_bg">
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_backgroundcoloractive']['color'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_backgroundcoloractive']['color'];?>" id="responsi-value-backgroundcoloractive" name="responsi-value-backgroundcoloractive" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
								<tr>
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_bordertopactive'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_bordertopactive'];?>" id="responsi-value-bordertopactive" name="responsi-value-bordertopactive" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
								<tr>
									<th width="23%" valign="top" scope="row">
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_borderbottomactive'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_borderbottomactive'];?>" id="responsi-value-borderbottomactive" name="responsi-value-borderbottomactive" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
								<tr>
									<th width="23%" valign="top" scope="row">
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_borderleftactive'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_borderleftactive'];?>" id="responsi-value-borderleftactive" name="responsi-value-borderleftactive" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
								<tr>
									<th width="23%" valign="top" scope="row">
									...
									<td class="responsi-marker-colourpicker-control">
										<input type="text" value="<?php echo $default_options['responsi_sc_tab_borderrightactive'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_borderrightactive'];?>" id="responsi-value-borderrightactive" name="responsi-value-borderrightactive" class="responsi-color-picker" style="display:none" />
									</td>
								</tr>
							</table>
						</td>
	  ...
	  <div class="sort_table_item" id="sort_table_item-1">
		...
		<table class="responsi-options-table">
			...
			<tr class="tab_icon">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="<?php echo $default_options['responsi_sc_tab_icon_color'];?>" data-default-color="<?php echo $default_options['responsi_sc_tab_icon_color'];?>" id="responsi-value-icon_color" name="responsi-value-icon_color" class="responsi-color-picker" style="display:none" />
				</td>
			</tr>
			<tr>
				<th valign="top" scope="row">
