    ...
    <div class="sort_table">
	  <div class="sort_table_item" id="sort_table_item-1">
	  	...
	  	<table class="responsi-options-table">
			<tr class="unorderedlist">
			    <th valign="top" scope="row" width="23%"><label for="responsi-value-unordered_list" class="">Unordered List<span class="optional"></span></label></th>
				<td class="responsi-marker-checkbox-iphone-control section">
					<div class="checkbox-wrapper"><input checked="checked" id="responsi-value-unordered_list" name="responsi-value-unordered_list" data-novalue="no" hidden_class="unordered_list" class="responsi-multi-logic responsi-input responsi-checkbox-iphone" type="checkbox" value="yes" checked_label="ON" unchecked_label="OFF" container_width="80" /></div>
				</td>
			</tr>
			<tr class="orderedlist">
			    <th valign="top" scope="row" width="23%"><label for="responsi-value-ordered_list" class="">Ordered List<span class="optional"></span></label></th>
				<td class="responsi-marker-checkbox-iphone-control section">
					<div class="checkbox-wrapper"><input id="responsi-value-ordered_list" name="responsi-value-ordered_list" data-novalue="no" hidden_class="ordered_list" class="responsi-multi-logic responsi-input responsi-checkbox-iphone" type="checkbox" value="yes" checked_label="ON" unchecked_label="OFF" container_width="80" /></div>
				</td>
			</tr>
		</table>
		...
		<table class="responsi-options-table">
			<tr>
				<td colspan="2"><h3>Ordered List</h3></td>
			</tr>
			<tr>
				<th valign="top" scope="row"><label for="responsi-value-style" class="">List Style<span class="optional"></span></label></th>
				<td class="responsi-marker-select-control">
					<select id="responsi-value-style" name="responsi-value-style" class="select input-select responsi-focus-here">
					<option value="armenian">armenian</option><option selected="selected" value="decimal">decimal (Default)</option><option value="decimal-leading-zero">decimal-leading-zero</option><option value="georgian">georgian</option><option value="lower-alpha">lower-alpha</option><option value="lower-greek">lower-greek</option><option value="lower-latin">lower-latin</option><option value="lower-roman">lower-roman</option><option value="upper-alpha">upper-alpha</option><option value="upper-latin">upper-latin</option><option value="upper-roman">upper-roman</option>
					</select>
				</td>
			</tr>
		</table>
		...
		<table class="responsi-options-table">
			<tr>
				<td colspan="2"><h3>Unordered List</h3></td>
			</tr>
			<tr class="iconctrl">
		...
		<table class="responsi-options-table tbopimg">
			...
			<tr class="tr_image">
				...
				<td>
					<input type="text" id="responsi-value-image_width" name="responsi-value-image_width" value="16" class="txt input-text regular-text code" />
				</td>
			</tr>
			...
			<tr class="tr_image">
				...
				<td>
					<input type="text" id="responsi-value-image_height" name="responsi-value-image_height" value="16" class="txt input-text regular-text code" />
				</td>
			</tr>
		</table>
