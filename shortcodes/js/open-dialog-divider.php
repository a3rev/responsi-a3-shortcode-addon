	  ...
	  <div class="sort_table_item" id="sort_table_item-1">
		<table class="responsi-options-table">
			...
			<tr>
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#555555" data-default-color="#555555" id="responsi-value-color" name="responsi-value-color" class="icolor-picker" />
				</td>
			</tr>
			<tr>
		...
		<table class="responsi-options-table container">
			...
			<tr>
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#e0dede" data-default-color="#e0dede" id="responsi-value-iconcolor" name="responsi-value-iconcolor" class="icolor-picker" />
				</td>
			</tr>
			<tr>
				<th width="23%" valign="top" scope="row">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#ffffff" data-default-color="#ffffff" id="responsi-value-iconbackground" name="responsi-value-iconbackground" class="icolor-picker" />
				</td>
			</tr>
			<tr>
				<th width="23%" valign="top" scope="row">
				...
				<td class="responsi-marker-colourpicker-control">
					<input type="text" value="#ffffff" data-default-color="#ffffff" id="responsi-value-iconborder" name="responsi-value-iconborder" class="icolor-picker" />
				</td>
			</tr>
		</table>
		<table class="responsi-options-table">
