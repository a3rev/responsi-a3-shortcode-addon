...
class Responsi_A3_Shortcode_Addon_Upgrade
{
	...
	protected $plugin_key     = RESPONSI_A3_SC_KEY;
	protected $plugin_version = RESPONSI_A3_SC_VERSION;
	protected $plugin_path    = RESPONSI_A3_SC_NAME;
...
new Responsi_A3_Shortcode_Addon_Upgrade();
